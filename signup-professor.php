...
<<<<<<< HEAD
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Verify reCAPTCHA
        $recaptchaSecretKey = "6Ld7t5MoAAAAAA8mMORxY9MAD1TevNqpf-lNvRhn"; // Secret key
        ...
        if ($recaptchaData->success) {
            ...
            $sql = "INSERT INTO `teacher` (name, email, cnic, password) VALUES ('$name', '$email', '$cnic', '$hashed_password')";
...
if ($showAlert) {
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Congratulations!</strong> Your account is now created, and you can login.
...
?>
  ...
  <div class="login-container">
    ...
    <form action="signup-professor.php" method="post">
      ...
      <div class="form-group">
        ...
        <small>Enter CNIC Number Without Dashes</small>
      </div>
      ...
      <div class="g-recaptcha" data-sitekey="6Ld7t5MoAAAAAERNXZMLuDOcwEKGar5P9TyZcOOM"></div>
      <div class="form-group">
    ...
    <p class="already-login">Already Registered? <a href="login-professor.php">Login</a></p>
  </div>
...
=======
    ...
    {   
        $sql =" INSERT INTO `teacher`(name,email,cnic, password)
  ...
  <body>
    ...
    <div class="login-container">
      ...
      <form action="signup-professor.php" method="post">
        ...
        <div class="form-group">
          <label for="cnic">CNIC</label>
          <input type="text" id="regnumber" name="cnic" required />
        </div>
        <div class="form-group">
          <label for="password">Password</label>
          <input type="password" id="password" name="password" required />
      ...
      <p>Alread Registered?<a href="login-professor.php">Login</a></p>
    </div>
